...
class _CreateexamState extends State<Createexam> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp( // MaterialApp is wrapped here, so it works correctly
      home: Scaffold(
        appBar: AppBar(
                ...
                ElevatedButton(
                  onPressed: () {
                    if (_formKey.currentState!.validate()) {
                      ...
                      debugPrint(
                          'Saving exam: Name: $_examName, Description: $_description, Duration: $_durationMinutes');
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(content: Text('Exam Saved!')),
                      );
                      // In a real app, you would navigate back or update state here.
                    }
                  },
...
/*void main() {
  runApp(const ExamPage(exam: null)); // Directly run the ExamPage
}*/